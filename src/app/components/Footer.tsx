      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <ul className="mt-6 space-y-8 text-gray-900 font-semibold">
              <li><a href="/">Home</a></li>
          ...
          <div>
            ...
            <ul className="mt-8 space-y-8 text-gray-900 font-semibold">
        ...
        <div>
          ...
          <div className="mt-8 flex items-center border-b border-gray-800 pb-2">
            <input
              type="email"
